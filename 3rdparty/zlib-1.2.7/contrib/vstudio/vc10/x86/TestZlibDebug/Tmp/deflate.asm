; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\sstrau\Downloads\zlib-1.2.7.tar\zlib-1.2.7\zlib-1.2.7\deflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
_deflate_copyright DB ' deflate 1.2.7 Copyright 1995-2012 Jean-loup Gaill'
...
_configuration_table DW 00H
	...
	DW	01000H
	DD	FLAT:_deflate_slow
?my_version@?1??deflateInit2_@@9@9 DB '1.2.7', 00H	; `deflateInit2_'::`2'::my_version
CONST	ENDS
PUBLIC	_deflateInit2_@32
PUBLIC	_deflateInit_@16
; Function compile flags: /Odtp /ZI
; File c:\users\sstrau\downloads\zlib-1.2.7.tar\zlib-1.2.7\zlib-1.2.7\deflate.c
...
tv286 = -108						; size = 4
tv190 = -108						; size = 4
_bstate$80734 = -40					; size = 4
_val$80708 = -36					; size = 4
_beg$80707 = -32					; size = 4
_val$80695 = -28					; size = 4
_beg$80694 = -24					; size = 4
_beg$80682 = -20					; size = 4
_level_flags$80668 = -16				; size = 4
_header$80667 = -12					; size = 4
_s$ = -8						; size = 4
_old_flush$ = -4					; size = 4
_strm$ = 8						; size = 4
_flush$ = 12						; size = 4
...
; 736  :             uInt header = (Z_DEFLATED + ((s->w_bits-8)<<4)) << 8;
	...
	add	ecx, 8
	shl	ecx, 8
	mov	DWORD PTR _header$80667[ebp], ecx
...
; 740  :                 level_flags = 0;
	...
	mov	DWORD PTR _level_flags$80668[ebp], 0
...
; 742  :                 level_flags = 1;
	...
	mov	DWORD PTR _level_flags$80668[ebp], 1
	jmp	SHORT $LN68@deflate
$LN67@deflate:
...
; 744  :                 level_flags = 2;
	...
	mov	DWORD PTR _level_flags$80668[ebp], 2
...
; 746  :                 level_flags = 3;
	...
	mov	DWORD PTR _level_flags$80668[ebp], 3
$LN68@deflate:

; 747  :             header |= (level_flags << 6);

	mov	eax, DWORD PTR _level_flags$80668[ebp]
	shl	eax, 6
	or	eax, DWORD PTR _header$80667[ebp]
	mov	DWORD PTR _header$80667[ebp], eax
...
; 748  :             if (s->strstart != 0) header |= PRESET_DICT;
	...
	mov	eax, DWORD PTR _header$80667[ebp]
	or	eax, 32					; 00000020H
	mov	DWORD PTR _header$80667[ebp], eax
$LN63@deflate:
...
; 749  :             header += 31 - (header % 31);
	...
	sub	eax, edx
	add	eax, DWORD PTR _header$80667[ebp]
	mov	DWORD PTR _header$80667[ebp], eax
...
; 765  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$80682[ebp], ecx
$LN59@deflate:
...
; 769  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$80682[ebp]
...
; 771  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$80682[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$80682[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 804  :                         val = 1;
	...
	mov	DWORD PTR _val$80695[ebp], 1
...
; 808  :                 val = s->gzhead->name[s->gzindex++];
	...
	mov	DWORD PTR _val$80695[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 809  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$80695[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 810  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$80695[ebp], 0
	jne	$LN49@deflate
$LN47@deflate:
...
; 824  :             uInt beg = s->pending;  /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$80707[ebp], ecx
$LN38@deflate:
...
; 829  :                     if (s->gzhead->hcrc && s->pending > beg)
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$80707[ebp]
...
; 831  :                                             s->pending - beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$80707[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$80707[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 835  :                         val = 1;
	...
	mov	DWORD PTR _val$80708[ebp], 1
...
; 839  :                 val = s->gzhead->comment[s->gzindex++];
	...
	mov	ecx, DWORD PTR [eax+32]
	movzx	edx, BYTE PTR [edx+ecx]
	mov	DWORD PTR _val$80708[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 840  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$80708[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 841  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$80708[ebp], 0
	jne	$LN38@deflate
$LN36@deflate:
...
$LN97@deflate:
	...
	mov	DWORD PTR _bstate$80734[ebp], eax

; 904  : 
; 905  :         if (bstate == finish_started || bstate == finish_done) {

	cmp	DWORD PTR _bstate$80734[ebp], 2
	je	SHORT $LN16@deflate
	cmp	DWORD PTR _bstate$80734[ebp], 3
...
; 908  :         if (bstate == need_more || bstate == finish_started) {
	...
	cmp	DWORD PTR _bstate$80734[ebp], 0
...
; 921  :         if (bstate == block_done) {
	...
	cmp	DWORD PTR _bstate$80734[ebp], 1
	jne	$LN19@deflate
...
tv149 = -100						; size = 4
tv138 = -100						; size = 4
_init$80882 = -32					; size = 4
_curr$80880 = -28					; size = 4
_str$80872 = -24					; size = 4
_wsize$ = -20						; size = 4
_more$ = -16						; size = 4
_p$ = -12						; size = 4
_m$ = -8						; size = 4
...
; 1470 :             uInt str = s->strstart - s->insert;
	...
	mov	DWORD PTR _str$80872[ebp], edx

; 1471 :             s->ins_h = s->window[str];

	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+56]
	mov	edx, DWORD PTR _str$80872[ebp]
...
; 1472 :             UPDATE_HASH(s, s->ins_h, s->window[str + 1]);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+56]
	mov	eax, DWORD PTR _str$80872[ebp]
...
; 1479 :                 s->prev[str & s->w_mask] = s->head[s->ins_h];
	...
	mov	eax, DWORD PTR [edx+68]
	mov	edx, DWORD PTR _s$[ebp]
	mov	esi, DWORD PTR _str$80872[ebp]
	and	esi, DWORD PTR [edx+52]
	mov	edx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [edx+64]
	mov	ax, WORD PTR [eax+ecx*2]
...
; 1481 :                 s->head[s->ins_h] = (Pos)str;
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+68]
	mov	dx, WORD PTR _str$80872[ebp]
	mov	WORD PTR [eax+ecx*2], dx
...
; 1482 :                 str++;
	...
	mov	eax, DWORD PTR _str$80872[ebp]
	add	eax, 1
	mov	DWORD PTR _str$80872[ebp], eax
...
; 1502 :         ulg curr = s->strstart + (ulg)(s->lookahead);
	...
	mov	edx, DWORD PTR _s$[ebp]
	add	ecx, DWORD PTR [edx+116]
	mov	DWORD PTR _curr$80880[ebp], ecx
...
; 1505 :         if (s->high_water < curr) {
	...
	cmp	ecx, DWORD PTR _curr$80880[ebp]
...
; 1509 :             init = s->window_size - curr;
	...
	sub	ecx, DWORD PTR _curr$80880[ebp]
	mov	DWORD PTR _init$80882[ebp], ecx

; 1510 :             if (init > WIN_INIT)

	cmp	DWORD PTR _init$80882[ebp], 258		; 00000102H
	jbe	SHORT $LN4@fill_windo

; 1511 :                 init = WIN_INIT;

	mov	DWORD PTR _init$80882[ebp], 258		; 00000102H
$LN4@fill_windo:

; 1512 :             zmemzero(s->window + curr, (unsigned)init);

	mov	eax, DWORD PTR _init$80882[ebp]
	push	eax
	push	0
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+56]
	add	edx, DWORD PTR _curr$80880[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 1513 :             s->high_water = curr + init;
	...
	mov	eax, DWORD PTR _curr$80880[ebp]
	add	eax, DWORD PTR _init$80882[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
; 1520 :             init = (ulg)curr + WIN_INIT - s->high_water;
	...
	mov	DWORD PTR _init$80882[ebp], eax
...
; 1521 :             if (init > s->window_size - s->high_water)
	...
	cmp	DWORD PTR _init$80882[ebp], edx
...
; 1522 :                 init = s->window_size - s->high_water;
	...
	mov	edx, DWORD PTR [eax+60]
	sub	edx, DWORD PTR [ecx+5824]
	mov	DWORD PTR _init$80882[ebp], edx
$LN1@fill_windo:
...
; 1524 :             s->high_water += init;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5824]
	add	ecx, DWORD PTR _init$80882[ebp]
	mov	edx, DWORD PTR _s$[ebp]
...
; 1670 :                            s->match_length - MIN_MATCH, bflush);
	...
	mov	ax, WORD PTR _dist$80956[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$80956[ebp], ax
	movzx	eax, BYTE PTR _len$80955[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$80955[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$80956[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN23@deflate_fa
	movzx	ecx, WORD PTR _dist$80956[ebp]
...
; 1706 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$80964[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
_cc$81031 = -22						; size = 1
_cc$81021 = -21						; size = 1
_dist$81006 = -20					; size = 2
_len$81005 = -13					; size = 1
_max_insert$81004 = -12					; size = 4
_bflush$ = -8						; size = 4
_hash_head$ = -4					; size = 4
_s$ = 8							; size = 4
_flush$ = 12						; size = 4
...
; 1789 :             uInt max_insert = s->strstart + s->lookahead - MIN_MATCH;
	...
	mov	DWORD PTR _max_insert$81004[ebp], ecx
...
; 1795 :                            s->prev_length - MIN_MATCH, bflush);
	...
	sub	ecx, 3
	mov	BYTE PTR _len$81005[ebp], cl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+108]
	sub	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	sub	ecx, DWORD PTR [edx+100]
	mov	WORD PTR _dist$81006[ebp], cx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$81006[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$81005[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$81006[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$81006[ebp], ax
	movzx	eax, BYTE PTR _len$81005[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$81005[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$81006[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN29@deflate_sl
	movzx	ecx, WORD PTR _dist$81006[ebp]
	movzx	edx, BYTE PTR __dist_code[ecx]
...
; 1805 :                 if (++s->strstart <= max_insert) {
	...
	cmp	ecx, DWORD PTR _max_insert$81004[ebp]
	ja	$LN15@deflate_sl
...
; 1821 :             _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81021[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81021[ebp]
...
tv210 = -96						; size = 4
_cc$81072 = -25						; size = 1
_dist$81070 = -24					; size = 2
_len$81069 = -17					; size = 1
_strend$ = -16						; size = 4
_scan$ = -12						; size = 4
_prev$ = -8						; size = 4
_bflush$ = -4						; size = 4
...
; 1904 :             _tr_tally_dist(s, 1, s->match_length - MIN_MATCH, bflush);
	...
	mov	ecx, DWORD PTR [eax+96]
	sub	ecx, 3
	mov	BYTE PTR _len$81069[ebp], cl
	mov	eax, 1
	mov	WORD PTR _dist$81070[ebp], ax
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$81070[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$81069[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$81070[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$81070[ebp], ax
	movzx	eax, BYTE PTR _len$81069[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$81069[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	eax, WORD PTR _dist$81070[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN23@deflate_rl
	movzx	ecx, WORD PTR _dist$81070[ebp]
	movzx	edx, BYTE PTR __dist_code[ecx]
...
; 1912 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81072[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81072[ebp]
...
; 1952 :         _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81105[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81105[ebp]
