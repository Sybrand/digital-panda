; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\sstrau\Downloads\zlib-1.2.7.tar\zlib-1.2.7\zlib-1.2.7\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\sstrau\downloads\zlib-1.2.7.tar\zlib-1.2.7\zlib-1.2.7\contrib\testzlib\testzlib.c
;	COMDAT _MyDoMinus64
_TEXT	SEGMENT
_R$ = 8							; size = 4
_A$ = 12						; size = 8
...
PUBLIC	??_C@_05HBMOAMF@1?42?47?$AA@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_05HBMOAMF@1?42?47?$AA@
CONST	SEGMENT
??_C@_05HBMOAMF@1?42?47?$AA@ DB '1.2.7', 00H		; `string'
CONST	ENDS
...
tv226 = -300						; size = 4
tv141 = -300						; size = 4
_all_read_before$81941 = -232				; size = 4
_step$81934 = -228					; size = 4
_lOrigDone$81933 = -224					; size = 4
_lOrigToDo$81932 = -220					; size = 4
_ret$81931 = -216					; size = 4
_zcpr$81930 = -212					; size = 56
_all_read_before$81921 = -156				; size = 4
_step$81913 = -152					; size = 4
_lOrigDone$81912 = -148					; size = 4
_lOrigToDo$81911 = -144					; size = 4
_ret$81910 = -140					; size = 4
_zcpr$81909 = -136					; size = 56
...
; 193  :         int ret=Z_OK;
	...
	mov	DWORD PTR _ret$81910[ebp], 0

; 194  :         long lOrigToDo = lFileSize;

	mov	eax, DWORD PTR _lFileSize$[ebp]
	mov	DWORD PTR _lOrigToDo$81911[ebp], eax

; 195  :         long lOrigDone = 0;

	mov	DWORD PTR _lOrigDone$81912[ebp], 0

; 196  :         int step=0;

	mov	DWORD PTR _step$81913[ebp], 0

; 197  :         memset(&zcpr,0,sizeof(z_stream));

	push	56					; 00000038H
	push	0
	lea	eax, DWORD PTR _zcpr$81909[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
; 198  :         deflateInit(&zcpr,cprLevel);
	...
	push	56					; 00000038H
	push	OFFSET ??_C@_05HBMOAMF@1?42?47?$AA@
	mov	eax, DWORD PTR _cprLevel$[ebp]
	push	eax
	lea	ecx, DWORD PTR _zcpr$81909[ebp]
	push	ecx
...
; 200  :         zcpr.next_in = FilePtr;
	...
	mov	DWORD PTR _zcpr$81909[ebp], eax

; 201  :         zcpr.next_out = CprPtr;

	mov	eax, DWORD PTR _CprPtr$[ebp]
	mov	DWORD PTR _zcpr$81909[ebp+12], eax
$LN8@main:
...
; 206  :             long all_read_before = zcpr.total_in;
	...
	mov	eax, DWORD PTR _zcpr$81909[ebp+8]
	mov	DWORD PTR _all_read_before$81921[ebp], eax

; 207  :             zcpr.avail_in = min(lOrigToDo,BlockSizeCompress);

	mov	eax, DWORD PTR _lOrigToDo$81911[ebp]
	cmp	eax, DWORD PTR _BlockSizeCompress$[ebp]
	jge	SHORT $LN17@main
	mov	ecx, DWORD PTR _lOrigToDo$81911[ebp]
...
$LN18@main:
	...
	mov	DWORD PTR _zcpr$81909[ebp+4], eax

; 208  :             zcpr.avail_out = BlockSizeCompress;

	mov	eax, DWORD PTR _BlockSizeCompress$[ebp]
	mov	DWORD PTR _zcpr$81909[ebp+16], eax

; 209  :             ret=deflate(&zcpr,(zcpr.avail_in==lOrigToDo) ? Z_FINISH : Z_SYNC_FLUSH);

	mov	eax, DWORD PTR _zcpr$81909[ebp+4]
	xor	ecx, ecx
	cmp	eax, DWORD PTR _lOrigToDo$81911[ebp]
	sete	cl
	lea	ecx, DWORD PTR [ecx+ecx+2]
	push	ecx
	lea	edx, DWORD PTR _zcpr$81909[ebp]
	push	edx
	call	_deflate@8
	mov	DWORD PTR _ret$81910[ebp], eax

; 210  :             lOrigDone += (zcpr.total_in-all_read_before);

	mov	eax, DWORD PTR _zcpr$81909[ebp+8]
	sub	eax, DWORD PTR _all_read_before$81921[ebp]
	add	eax, DWORD PTR _lOrigDone$81912[ebp]
	mov	DWORD PTR _lOrigDone$81912[ebp], eax
...
; 211  :             lOrigToDo -= (zcpr.total_in-all_read_before);
	...
	mov	ecx, DWORD PTR _lOrigToDo$81911[ebp]
	sub	ecx, eax
	mov	DWORD PTR _lOrigToDo$81911[ebp], ecx

; 212  :             step++;

	mov	eax, DWORD PTR _step$81913[ebp]
	add	eax, 1
	mov	DWORD PTR _step$81913[ebp], eax

; 213  :         } while (ret==Z_OK);

	cmp	DWORD PTR _ret$81910[ebp], 0
	je	$LN8@main

; 214  : 
; 215  :         lSizeCpr=zcpr.total_out;

	mov	eax, DWORD PTR _zcpr$81909[ebp+20]
...
; 234  :         int ret=Z_OK;
	...
	mov	DWORD PTR _ret$81931[ebp], 0

; 235  :         long lOrigToDo = lSizeCpr;

	mov	eax, DWORD PTR _lSizeCpr$[ebp]
	mov	DWORD PTR _lOrigToDo$81932[ebp], eax

; 236  :         long lOrigDone = 0;

	mov	DWORD PTR _lOrigDone$81933[ebp], 0

; 237  :         int step=0;

	mov	DWORD PTR _step$81934[ebp], 0

; 238  :         memset(&zcpr,0,sizeof(z_stream));

	push	56					; 00000038H
	push	0
	lea	eax, DWORD PTR _zcpr$81930[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
; 241  :         zcpr.next_in = CprPtr;
	...
	mov	eax, DWORD PTR _CprPtr$[ebp]
	mov	DWORD PTR _zcpr$81930[ebp], eax

; 242  :         zcpr.next_out = UncprPtr;

	mov	eax, DWORD PTR _UncprPtr$[ebp]
	mov	DWORD PTR _zcpr$81930[ebp+12], eax
$LN5@main:
...
; 247  :             long all_read_before = zcpr.total_in;
	...
	mov	eax, DWORD PTR _zcpr$81930[ebp+8]
	mov	DWORD PTR _all_read_before$81941[ebp], eax

; 248  :             zcpr.avail_in = min(lOrigToDo,BlockSizeUncompress);

	mov	eax, DWORD PTR _lOrigToDo$81932[ebp]
	cmp	eax, DWORD PTR _BlockSizeUncompress$[ebp]
	jge	SHORT $LN19@main
	mov	ecx, DWORD PTR _lOrigToDo$81932[ebp]
...
; 250  :             ret=inflate(&zcpr,Z_SYNC_FLUSH);
	...
	push	eax
	call	_inflate@8
	mov	DWORD PTR _ret$81931[ebp], eax

; 251  :             lOrigDone += (zcpr.total_in-all_read_before);

	mov	eax, DWORD PTR _zcpr$81930[ebp+8]
	sub	eax, DWORD PTR _all_read_before$81941[ebp]
	add	eax, DWORD PTR _lOrigDone$81933[ebp]
	mov	DWORD PTR _lOrigDone$81933[ebp], eax
...
; 252  :             lOrigToDo -= (zcpr.total_in-all_read_before);
	...
	mov	ecx, DWORD PTR _lOrigToDo$81932[ebp]
	sub	ecx, eax
	mov	DWORD PTR _lOrigToDo$81932[ebp], ecx

; 253  :             step++;

	mov	eax, DWORD PTR _step$81934[ebp]
	add	eax, 1
	mov	DWORD PTR _step$81934[ebp], eax

; 254  :         } while (ret==Z_OK);

	cmp	DWORD PTR _ret$81931[ebp], 0
	je	$LN5@main

; 255  : 
; 256  :         lSizeUncpr=zcpr.total_out;

	mov	eax, DWORD PTR _zcpr$81930[ebp+20]
